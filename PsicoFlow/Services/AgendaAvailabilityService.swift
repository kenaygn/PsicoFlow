...
class AgendaAvailabilityService {
    ...
    // Matriz de horários do expediente
    ...
    func horariosLivresParaContrato(diaDaSemana: Int, ignorandoContratoID: String? = nil) -> [String] {
    ...
    func horariosLivresParaSessaoAvulsa(data: Date, ignorandoSessaoID: String? = nil, derivadaDeContratoID: String? = nil) -> [String] {
